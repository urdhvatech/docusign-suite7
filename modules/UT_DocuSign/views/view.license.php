...
class ViewLicense extends SugarView
{
    protected function _getModuleTitleParams($browserTitle = false)
    {
        ...
        return array(
           ...
           translate('LBL_ESIGN_DOCUSIGNADDON', 'Administration').': '.translate('LBL_ESIGN_DOCUSIGN_LICENSE_TITLE', 'Administration'),
           );
    }
    ...
    public function display()
    {
        ...
        $key = UTDocusignLicense::getKey($currentModule);
        ...
        if (isset($outfitters_config['manage_licensed_users']) && $outfitters_config['manage_licensed_users'] == true) {
            ...
            if (!empty($trimmed_last)) {
                ...
                $validated = UTDocusignLicense::doValidate($currentModule);
